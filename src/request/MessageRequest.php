...
class MessageRequest extends Request
{
     ...
     * @return array
     */
    public function getMessage($type, $queryExt = '')
    {
        return $this->queryApi('api/message/get', ['type' => implode(',', $type), 'queryExt' => $queryExt]);
    }
    ...
    public function delMessage(array $ids)
    {
        ...
        return $this->queryApi('api/message/del', ['id' => implode(',', $ids)]);
    }
}