...
class AfterSaleRequest extends Request
{
     ...
     * @return array
     */
    public function createAfsApply(array $params)
    {
//        $arrPara = [
...
//        return $this->commonQuery('api/afterSale/createAfsApply', $paramsResult['data']);
        return $this->commonQuery('api/afterSale/createAfsApply', $params);
    }
    ...
    public function updateSendSku($afsServiceId, $expressCompany, $deliverDate, $expressCode, $freightMoney = 0.0)
    {
        $params = [
            ...
            'freightMoney' => floatval($freightMoney),
        ];
     ...
     * @return array
     */
    public function getOrderPayByOrderId($orderId, $refId)
    {
        $params = [
            'orderId' => $orderId,
            'refId' => $refId,
        ];
        return $this->queryApi('api/afterSale/getOrderPayByOrderId', $params);
    }
    ...
    public function confirmAfsOrder($customerName, $username, $afsServiceId)
    {
        ...
        //return $this->commonQuery('api/afterSale/auditCancel', $params);
        return $this->queryApi('api/afterSale/confirmAfsOrder', $params);
    }
    ...
    public function getAfsServiceListPage(array $query = ['pageIndex' => 1, 'pageSize' => 20])
    {
        ...
        return $this->commonQuery('api/afterSale/getAfsServiceListPage', $query);
    }
